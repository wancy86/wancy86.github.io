angular.module('otherModual', [])

.service('otherServ', [function() {
    this.log = function(msg) {
        console.log('otherModual.otherServ.log: ', msg || 'no msg...')
    }
}]);


angular.module('myapp', ['otherModual'])

.run(function() {
    console.log('1111:', 1111);
})

.controller('shoppingCartCtrl', ['$scope', '$filter','otherServ',function($scope, $filter,otherServ) {
    otherServ.log('=================')
